...
let parserService = require('../services/parser');
...
module.exports = (app, db) => {
    ...
    router.get('/parser/parsing-from-pionerkg', (req, res) => {
        parserService.getMainCategories().then(
            (mainCategroies) => {
                console.log(mainCategroies, 'file: /router/product.js, line:555');
                 parserService.getChildCategories(mainCategroies[2]).then(
                    (data) => {
                        /* data = {
